...
CREATE TABLE "Card" (
    ...
    "seriesId" TEXT NOT NULL DEFAULT 'coplanar-comics-series-1',
    "frontImagePath" TEXT,
    "backImagePath" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "PackOpened" (
    ...
    CONSTRAINT "PackOpened_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "PackOpened_userId_idx" ON "PackOpened"("userId");
...
-- AddForeignKey
ALTER TABLE "PackOpened" ADD CONSTRAINT "PackOpened_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
