...
function renderSlot(
  ...
  return (
    <div key={slot.printId} className={slotClassName}>
  ...
  return (
    <>
      <div className={styles.pageGrid}>
        {slots.map((slot) =>
          renderSlot(slot, onSelectCard, styles.slotWrapper)
        )}
      </div>

      <HorizontalScrollRail
        className={styles.pageGridMobileRail}
        scrollerClassName={styles.pageGridMobileScroller}
        aria-label="Binder page cards"
      >
        {slots.map((slot) =>
          renderSlot(slot, onSelectCard, styles.slotWrapperMobile)
        )}
      </HorizontalScrollRail>
    </>
  );
